            ...
            <div className="bg-white rounded-lg shadow-sm border p-6">
             ...
             <Link href={"/orders"}>
              <button 
                ...
                className="w-full bg-black text-white py-3 px-4 font-medium hover:bg-red-500 transition-colors"
              >
                ORDERS
              </button>
             </Link>
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6">
              ...
              <div className="mb-8">
                ...
                <button 
                  ...
                  className="w-full bg-black text-white py-3 px-4 font-medium hover:bg-red-500 transition-colors mb-8"
                >
                  EDIT DETAILS
                </button>
              </div>
              ...
              <div>
                ...
                <button  onClick={() => signOut({ callbackUrl: '/' })}
                   className="w-full bg-black text-white py-3 px-4 font-medium hover:bg-red-500 transition-colors flex items-center justify-center"
                >
