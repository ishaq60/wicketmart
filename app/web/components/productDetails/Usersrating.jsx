        ...
        <form>
          ...
          <DialogContent className="sm:max-w-[425px] h-[750px] lg:max-w-[1050px]">
            <DialogHeader className="">
              <DialogTitle className="text-2xl font-bold">Write down Your Review</DialogTitle>
            ...
            <div className="grid mb-6 ">
              <div className="grid  gap-3">
                <Label className="w-2 text-xl font-bold" htmlFor="name-1">Title</Label>
                <Input className="p-6" id="name-1" name="name" placeholder="Enter the Title here" defaultValue="title" />
              </div>
              <div className="grid gap-3">
                <Label className="w-2 border-gray-200 text-xl font-bold" htmlFor="username-1">Username</Label>
                <Input
              ...
              <h1 className="text-xl font-bold mt-3">Would you recommend this product?</h1>
              <RadioGroup defaultValue="comfortable">
      
      <div className="flex text-3xl items-center gap-3">
        <RadioGroupItem className="text-2xl" value="comfortable" id="r2" />
        <Label className="w-2 text-xl" htmlFor="r2">Yes</Label>
      </div>
      <div className="flex items-center gap-3">
        <RadioGroupItem  value="compact" id="r3" />
        <Label className="w-2 text-xl" htmlFor="r3">No</Label>
      </div>
    </RadioGroup>
            </div>
            <DialogFooter>
              <DialogClose asChild>
                <Button className=" text-black text-xl py-6 px-8 h-2" variant="outline">Cancel</Button>
              </DialogClose>
              <Button className="hover:bg-red-500 text-white text-xl py-6 px-8 h-2" type="submit ">submit</Button>
            </DialogFooter>
          </DialogContent>
        </form>
      </Dialog>
